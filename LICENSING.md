...
Scripts uses a **dual-license model**: open source for the community,
...
1. Use Scripts commercially with **>50 users** and **>$5M revenue/year**
2. Distribute Scripts inside a product **without** releasing your source under AGPLv3
3. Offer Scripts as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer Scripts
...
Open an issue: https://github.com/egkristi/scripts/issues
